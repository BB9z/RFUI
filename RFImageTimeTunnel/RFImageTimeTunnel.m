...
- (IBAction)onAlphaMode:(UISwitch *)sender {
	isAlphaTransformEnable = sender.isOn;
}

- (IBAction)onModeChange:(UISegmentedControl *)sender {
	if(sender.selectedSegmentIndex == 0){
		gestureMode = RFImageTimeTunnelGestureModePosition;
	}
	else {
		gestureMode = RFImageTimeTunnelGestureModeSpeed;
	}
}
